...
predicted_pkl_path = '/media/franco/hdd/matteogombia/OpenPCDet/output/result.pkl'
txt_prediction_path = '/media/franco/hdd/matteogombia/OpenPCDet/output/data'
# folder containing vod_lidar and vod_radar 
root_dir = '/media/franco/hdd/dataset/VoD/view_of_delft_PUBLIC/' 
...
op_dir = '/media/franco/hdd/matteogombia/OpenPCDet/output/visualization_2D/' # where to save the visualizations
...
for id in tqdm(frame_ids):
    ...
    vis2d.draw_plot(show_radar=True,show_lidar=False,show_gt=False,show_pred=True, plot_figure=False, save_figure=True)
